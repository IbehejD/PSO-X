...
bool Configuration::getConfig(int argc, char *argv[])
{
	...
	{
		if (particles < initialPopSize)
			particles = initialPopSize;
		if (particles > finalPopSize)
			particles = finalPopSize;
	}
...
void Configuration::setDefaultParameters()
{
	...
	mag1_sc = 0;
	mag1_fc = 0; // success and failure counters
	mag2_sc = 0;
	mag2_fc = 0; // success and failure counters
...
void Configuration::printParameters()
{
	...
	{
	case CEC05:
		cout << "  competition:       CEC05\n";
		break;
	case CEC14:
		cout << "  competition:       CEC14\n";
		break;
	case SOFT_COMPUTING:
		cout << "  competition:       SOFT_COMPUTING\n";
		break;
	case MIXTURE:
		cout << "  competition:       MIXTURE\n";
		break;
	}
	...
	{
	case true:
		cout << "  reinitilize_pos:   YES\n";
		break;
	case false:
		cout << "  reinitilize_pos:   NO\n";
		break;
	}
	switch (detectParticleStagnated())
	{
	case true:
		cout << "  detect_stagnation: YES\n";
		break;
	case false:
		cout << "  detect_stagnation: NO\n";
		break;
	}
	switch (usePerturbedlBest())
	{
	case true:
		cout << "  perturbedlBest:    YES\n";
		break;
	case false:
		cout << "  perturbedlBest:    NO\n";
		break;
	}
	switch (getPopulationCS())
	{
	case POP_CONSTANT:
		cout << "  populationCS:      POP_CONSTANT\n";
		break;
	case POP_TIME_VARYING:
		cout << "  populationCS:      POP_TIME_VARYING\n"
			 << "  minimumPopSize:    " << initialPopSize << "\n"
			 << "  maximumPopSize:    " << finalPopSize << "\n"
			 << "  popTViterations:   " << getPopTViterations() << "\n";
		break;
	case POP_INCREMENTAL:
		cout << "  populationCS:      POP_INCREMENTAL\n"
	...
	{
	case MOI_BEST_OF_N:
		cout << "  modelOfInfluence:  BEST_OF_NEIGHBORHOOD\n";
		break;
	case MOI_FI:
		cout << "  modelOfInfluence:  FI\n";
		break;
	case MOI_RANKED_FI:
		cout << "  modelOfInfluence:  RANKED_FI\n";
		break;
	}
	switch (getTopology())
	{
	case TOP_FULLYCONNECTED:
		cout << "  topology:          TOP_FULLYCONNECTED\n";
		break;
	case TOP_RING:
		cout << "  topology:          TOP_RING\n";
		break;
	case TOP_WHEEL:
		cout << "  topology:          TOP_WHEEL\n";
		break;
	case TOP_RANDOM:
		cout << "  topology:          TOP_RANDOM\n";
		break;
	case TOP_VONNEUMANN:
		cout << "  topology:          TOP_VONNEUMANN\n";
		break;
	case TOP_TIMEVARYING:
		cout << "  topology:          TOP_TIMEVARYING\n";
	...
	case TOP_HIERARCHICAL:
		cout << "  topology:          TOP_HIERARCHICAL\n"
	...
	{
	case true:
		cout << "  randNeighbor:      YES\n";
		break;
	case false:
		cout << "  randNeighbor:      NO\n";
		break;
	}
	switch (useVelocityClamping())
	{
	case true:
		cout << "  velocity clamped:  YES\n";
		break;
	case false:
		cout << "  velocity clamped:  NO\n";
		break;
	}
	switch (getOmega1CS())
	{
	...
	{
	case O2_EQUAL_TO_O1:
		cout << "  omega2CS:          EQUAL_TO_omega1\n";
		break;
	case O2_ZERO:
		cout << "  omega2CS:          ZERO (no DNNP)\n";
		break;
	case O2_ONE:
		cout << "  omega2CS:          ONE\n";
		break;
	case O2_RANDOM:
		cout << "  omega2CS:          RANDOM\n";
		break;
	case O2_CONSTANT:
		cout << "  omega2CS:          CONSTANT\n"
			 << "  omega2:            " << getOmega2() << "\n";
		break;
	}
	switch (getOmega3CS())
	{
	case O3_EQUAL_TO_O1:
		cout << "  omega3CS:          EQUAL_TO_omega1\n";
		break;
	case O3_ZERO:
		cout << "  omega3CS:          ZERO (no additive perturbation)\n";
		break;
	case O3_ONE:
		cout << "  omega3CS:          ONE\n";
		break;
	case O3_RANDOM:
		cout << "  omega3CS:          RANDOM\n";
		break;
	case O3_CONSTANT:
		cout << "  omega3CS:          CONSTANT\n"
			 << "  omega3:            " << getOmega3() << "\n";
		break;
	}
	...
	{
	case AC_CONSTANT:
		cout << "  accelCoeffCS:      CONSTANT\n"
			 << "  phi_1:             " << getPhi1() << "\n"
			 << "  phi_2:             " << getPhi2() << "\n";
		break;
	case AC_TIME_VARYING:
		cout << "  accelCoeffCS:      TIME_VARYING\n"
	...
	case AC_EXTRAPOLATED:
		cout << "  accelCoeffCS:      EXTRAPOLATED\n";
		break;
	case AC_RANDOM:
		cout << "  accelCoeffCS:      RANDOM\n"
			 << "  initialPhi1:       " << getInitialPhi1() << "\n"
			 << "  finalPhi1:         " << getFinalPhi1() << "\n"
			 << "  initialPhi2:       " << getInitialPhi2() << "\n"
			 << "  finalPhi2:         " << getFinalPhi2() << "\n";
	...
	{
	case PERT1_NONE:
		cout << "  perturbation1CS:   NONE\n";
		break;
	case PERT1_GAUSSIAN:
		cout << "  perturbation1CS:   GAUSSIAN\n";
		break;
	case PERT1_LEVY:
		cout << "  perturbation1CS:   CAUCHY\n";
		break;
	case PERT1_UNIFORM:
		cout << "  perturbation1CS:   UNIFORM\n";
		break;
	}
	switch (getMagnitude1CS())
	{
	case MAGNITUDE_CONSTANT:
		cout << "  magnitude1CS:      CONSTANT\n"
			 << "  magnitude1:        " << getMagnitude1() << "\n";
		break;
	case MAGNITUDE_EUC_DISTANCE:
		cout << "  magnitude1CS:      EUCLIDEAN_DISTANCE\n";
		switch (getMagnitude1_parm_l_CS())
		{
		case MAG_PARAM_L_INDEPENDENT:
			cout << "  mag1_parm_l_CS:    INDEPENDENT\n";
			break;
		case MAG_PARAM_L_USER_SUPPLIED:
			cout << "  mag1_parm_l_CS:    USER_SUPPLIED\n";
			break;
		}
		cout << "  mag1_parm_l:       " << getMag1_parm_l() << "\n";
		break;
	case MAGNITUDE_OBJ_F_DISTANCE:
		cout << "  magnitude1CS:      OBJECTIVE_F_DISTANCE\n"
			 << "  mag1_parm_m:       " << getMag1_parm_m() << "\n";
		break;
	case MAGNITUDE_SUCCESS:
		cout << "  magnitude1CS:      SUCCESS\n"
			 << "  magnitude1:        " << getMagnitude1() << "\n"
	...
	{
	case PERT2_NONE:
		cout << "  perturbation2CS:   NONE\n";
		break;
	case PERT2_RECTANGULAR:
		cout << "  perturbation2CS:   RECTANGULAR\n";
		break;
	case PERT2_NOISY:
		cout << "  perturbation2CS:   NOISY\n";
		break;
	}
	switch (getMagnitude2CS())
	{
	case MAGNITUDE_CONSTANT:
		cout << "  magnitude2CS:      CONSTANT\n"
			 << "  magnitude2:        " << getMagnitude2() << "\n";
		break;
	case MAGNITUDE_EUC_DISTANCE:
		cout << "  magnitude2CS:      EUCLIDEAN_DISTANCE\n";
		switch (getMagnitude2_parm_l_CS())
		{
		case MAG_PARAM_L_INDEPENDENT:
			cout << "  mag2_parm_l_CS:    INDEPENDENT\n";
			break;
		case MAG_PARAM_L_USER_SUPPLIED:
			cout << "  mag2_parm_l_CS:    USER_SUPPLIED\n";
			break;
		}
		cout << "  mag2_parm_l:       " << getMag2_parm_l() << "\n";
		break;
	case MAGNITUDE_OBJ_F_DISTANCE:
		cout << "  magnitude2CS:      OBJECTIVE_F_DISTANCE\n"
			 << "  mag2_parm_m:       " << getMag2_parm_m() << "\n";
		break;
	case MAGNITUDE_SUCCESS:
		cout << "  magnitude2CS:      SUCCESS\n"
			 << "  magnitude2:        " << getMagnitude2() << "\n"
	...
	{
	case MATRIX_NONE:
		cout << "  randomMatrix:      NONE\n";
		break;
	case MATRIX_DIAGONAL:
		cout << "  randomMatrix:      DIAGONAL\n";
		break;
	case MATRIX_LINEAR:
		cout << "  randomMatrix:      LINEAR\n";
		break;
	case MATRIX_RRM_EXP_MAP:
		cout << "  randomMatrix:      RRM_EXP_MAP\n";
		switch (getAngleCS())
		{
		case ANGLE_CONSTANT:
			cout << "  angleCS:           CONSTANT\n"
		...
		break;
	case MATRIX_RRM_EUCLIDEAN_ONE:
		cout << "  randomMatrix:      RRM_EUCLIDEAN_ONE\n";
		switch (getAngleCS())
		{
		case ANGLE_CONSTANT:
			cout << "  angleCS:           CONSTANT\n"
		...
		break;
	case MATRIX_RRM_EUCLIDEAN_ALL:
		cout << "  randomMatrix:      RRM_EUCLIDEAN_ALL\n";
		switch (getAngleCS())
		{
		case ANGLE_CONSTANT:
			cout << "  angleCS:           CONSTANT\n"
		...
		break;
	case MATRIX_GROUPED_INCREASING:
		cout << "  randomMatrix:      GROUPED INCREASING\n";
		break;
	}
	switch (getDistributionNPP())
	{
	case DIST_RECTANGULAR:
		cout << "  DistributionNPP:   RECTANGULAR\n";
		break;
	case DIST_SPHERICAL:
		cout << "  DistributionNPP:   SPHERICAL\n";
		break;
	case DIST_ADD_STOCH:
		cout << "  DistributionNPP:   ADD_STOCH\n";
		switch (getOperator_q())
		{
		case Q_STANDARD:
			cout << "  operator_q:        STANDARD\n";
			break;
		case Q_GAUSSIAN:
			cout << "  operator_q:        GAUSSIAN\n";
			break;
		case Q_DISCRETE_2:
			cout << "  operator_q:        DISCRETE_2\n";
			break;
		case Q_CAUCHY_NORMAL:
			cout << "  operator_q:        CAUCHY_NORMAL\n"
